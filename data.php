...
<svg xmlns="http://www.w3.org/2000/svg" class="d-none">
  ...
  <nav class="navbar navbar-expand-md navbar-light fixed-top bg-light">
    <div class="container-fluid">
      ...
      <a href="../index.php"  class="navbar-brand" href="#">SMKN 1 PROBOLINGGO</a>
        ...
        <div class="col">
            <div class="card">
                <div class="card-header d-flex">
                    Data Siswa SMK Negeri 1 Probolinggo
                        ...
                        <table class="table table-striped mt-2 shadow-sm">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col"><img src="../image/instagram-icon.png" alt="Instagram" style="width: 20px; height: 20px;">Instagram</th>
                            ...
                            <tbody>
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="7">No data found</td> <!-- Changed colspan to 7 to match the number of columns -->
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
